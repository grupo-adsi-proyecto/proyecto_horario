...
//Create
//// Insercion FICHA  //////////////////////////////////////////////////////////////
function createambiente($Cod_F,$Num_Cupo,$Cod_P,$Cod_J){ 
    global $conn;
    $fi1 = "INSERT  INTO Ambiente (Cod_Amb,Num_Amb,Tipo_Amb,Localizacion,Estado_Amb,Cupo_Amb,Cod_S) VALUES ('$Cod_F','$Num_Cupo','$Cod_P','$Cod_J')";
   //faltan las foraneas

  ...
  <div id="container">
        ...
        <div id="parentVerticalTab">
            ...
            <div class="resp-tabs-container hor_1">
                ...
                <div>
<form class="form-signin" method="post" action="../controller/progManagment.php" >
      Ingresar codigo del Programa:
<!--<form class="form-inline my-2 my-lg-0">-->
      <input class="form-control mr-sm-2" name="Cod_P" type="number" placeholder="CodigoPrograma" aria-label="Search">
      Ingresar descripción del Programa:

      <input class="form-control mr-sm-2" name="Descrip_P" type="text" placeholder="Programa" aria-label="Search">
      Ingresar duración del Programa:

      <input class="form-control mr-sm-2" name="Duracion" type="date"  placeholder="" aria-label="Search">
      Seleccionar modalidad del Programa:
     <div > 
  <select class="form-control mr-sm-2" name="Mod_Form">
    <option value="op-1">Presencial</option>
    <option value="op-2">Virtual</option>
  </select>
</div> 
      Ingresar versión del Programa:

      <input class="form-control mr-sm-2" name="Version" type="number" placeholder="Version" aria-label="Search">
      <!-- <input class="form-control mr-sm-2" name="Duracion" type="date" placeholder="" aria-label="Search"> -->

      <input   type="submit"  class="btn btn-success mb-2" value="Guardar"/>
      </form>
                              <?php if (isset($_GET['mensaje_pro'])) {?> <!-- desde aqui los alertas -->
                        <div class="alert alert-success" role="alert">
                          <?php echo $_GET['mensaje_pro'];?>
                        </div>
                        <?php } ?>
                      <?php if (isset($_GET['error_pro'])) {?>
                      <div class="alert alert-danger" role="alert">
                        
                          <?php echo $_GET['error_pro'];?>

  ...
  <div id="container">
        ...
        <div id="parentVerticalTab">
            ...
            <div class="resp-tabs-container hor_1">
                ...
                <div>
                  <form class="form-signin" method="post" action="../controller/diaManagment.php" >
 Ingresar Codigo del Dia:
<!--<form class="form-inline my-2 my-lg-0">-->
      <input class="form-control mr-sm-2" name="Cod_D" type="number" placeholder="CodigoDia" aria-label="Search">
Ingresar Nombre del Dia:

      <input class="form-control mr-sm-2" name="Nom_D" type="text" placeholder="Dia" aria-label="Search">
      <input   type="submit"  class="btn btn-success mb-2" value="Guardar"/>
      </form>


      
                              <?php if (isset($_GET['mensaje_dia'])) {?> <!-- desde aqui los alertas -->
                        <div class="alert alert-success" role="alert">
                          <?php echo $_GET['mensaje_dia'];?>
                        </div>
                        <?php } ?>
                      <?php if (isset($_GET['error_dia'])) {?>
                      <div class="alert alert-danger" role="alert">
                        
                          <?php echo $_GET['error_dia'];?>
                       <?php } ?> <!-- hasta aca los alertas -->


      <!-- <BR><button class="btn btn-success">Guardar Dia </BR> </button> -->

...
require '../controller/ambienteManagment.php';
                    ...
                    <div>
                      <form class="form-signin" method="post" action="../controller/ambienteManagment.php">
                        ...
                        Ingresar Estado del Ambiente:
                          <div > 
                       <select class="form-control mr-sm-2" name="Estado_Amb" type="number">
                        ...
                        <div>
                          ...
                          <!--<div > 
                       <select class="form-control mr-sm-2" name="Cod_S" >
                                <option value="77">Paloquemado</option>
                                <option value="66">CIDCA</option>
                                <option value="55">ECCI</option>
                        </select>
                        </div> -->
                        ...
                        <?php if (isset($_GET['mensaje_ambiente'])) {?> <!-- desde aqui los alertas -->
                        <div class="alert alert-success" role="alert">
                          <?php echo $_GET['mensaje_ambinete'];?>
                        </div>
                        <?php } ?>
                      <?php if (isset($_GET['error_ambiente'])) {?>
                      <div class="alert alert-danger" role="alert">                        
                          <?php echo $_GET['error_ambiente'];?>

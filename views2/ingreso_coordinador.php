              ...
              <div id="container">
                ...
                <div id="parentVerticalTab">
                  ...
                  <div class="resp-tabs-container hor_1">
                    ...
                    <div>
                      <form method="post" action="../controller/coorManagment.php">

                        Ingresar Numero de Identificaión:
                        <!--<form class="form-inline my-2 my-lg-0">-->
                        <input class="form-control mr-sm-2" name="ID_Coor" type="text" placeholder="num cedula" aria-label="Search">
                       
                        Ingresar Nombre de Coordinador:
                        <input class="form-control mr-sm-2" name="Nom_Coor" type="text" placeholder="num cod" aria-label="Search">

                        Ingresar Contraseña:
                        <input class="form-control mr-sm-2" name="Contra_Coor" type="text" placeholder="contraseña" aria-label="Search">
                        
                        
                        Ingresar Telefono:
                        <input class="form-control mr-sm-2" name="Tel_Coor" type="number" placeholder="telefono" aria-label="Search">
                       
                        Ingresar Email:
                        <input class="form-control mr-sm-2" name="Email_Coor" type="text" placeholder="email" aria-label="Search">
                       
                        Ingresar Direccion:
                        <input class="form-control mr-sm-2" name="Direc_Coor" type="text" placeholder="direccion" aria-label="Search">
                        ...
                        <div>
                          <select class="form-control mr-sm-2" name="Cod_S" type="number">
                            <?php
                            foreach ($lista_sedes as $entry) {
                              ?>
                      ...
                      <?php if (isset($_GET['mensaje_ficha'])) {?> <!-- desde aqui los alertas -->
                        <div class="alert alert-success" role="alert">
                          <?php echo $_GET['mensaje_ficha'];?>
                        </div>
                        <?php } ?>
                      <?php if (isset($_GET['error_ficha'])) {?>
                      <div class="alert alert-danger" role="alert">
                        
                          <?php echo $_GET['error_ficha'];?>

...
require '../controller/fichaManagment.php';
              ...
              <div id="container">
                ...
                <div id="parentVerticalTab">
                  ...
                  <div class="resp-tabs-container hor_1">
                    ...
                    <div>
                      <form method="post" action="../controller/fichaManagment.php">
                        Ingresar Codigo de la Ficha:
                        <!--<form class="form-inline my-2 my-lg-0">-->
                        <input class="form-control mr-sm-2" name="Cod_F" type="number" placeholder="CodigoFicha" aria-label="Search">
                        Ingresar Numero de Cupo:

                        <input class="form-control mr-sm-2" name="Num_Cupo" type="number" placeholder="Cupo" aria-label="Search">
                       ...
                       Seleccionar programa
                        <?php
                        $lista_programas = getProgramas();
                        ?>

                        <div>
                          <select class="form-control mr-sm-2" name="Cod_P">
                            <?php

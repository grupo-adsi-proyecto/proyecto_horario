...
<?php
	...
	class PDF extends FPDF
	{
		function Header()
		{
			...
			$this->Cell(250,25, 'Reporte Administrador',0,0,'C');
			$this->Ln(30);
		}
	...
	$pdf->Cell(40,7,'INSTRUCTOR',1,0,'C',1);
	$pdf->Cell(60,7,'RAE',1,1,'C',1);
	//$pdf->SetXY(15,15);
	...
	while($row = $resultado->fetch_assoc())
	{
		...
		$pdf->Cell(40,7,utf8_decode($row['Nom_Inst']),1,0,'C');
		$pdf->Cell(60,7,utf8_decode($row['Cod_RAE']),1,1,'C');
